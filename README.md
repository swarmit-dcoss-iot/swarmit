...
Swarmit depends on the [DotBot-libs](https://github.com/swarmit-dcoss-iot/DotBot-libs)
and [Mari](https://github.com/swarmit-dcoss-iot/mari) repositories. They are included
...
```
git clone --recurse-submodules https://github.com/swarmit-dcoss-iot/swarmit.git
```
...
This gateway uses the [mari](https://github.com/swarmit-dcoss-iot/mari) network stack and
must run the Mari gateway firmware.

The documentation to setup a Mari gateway is located
[here](https://github.com/swarmit-dcoss-iot/mari/wiki/Getting-started#running-mari-network-on-your-computer).
...
[ci-badge]: https://github.com/swarmit-dcoss-iot/swarmit/workflows/CI/badge.svg
[ci-link]: https://github.com/swarmit-dcoss-iot/swarmit/actions?query=workflow%3ACI+branch%3Amain

[codecov-badge]: https://codecov.io/gh/swarmit-dcoss-iot/swarmit/branch/main/graph/badge.svg
[codecov-link]: https://codecov.io/gh/swarmit-dcoss-iot/swarmit
...
[license-link]: https://github.com/swarmit-dcoss-iot/swarmit/blob/main/LICENSE
